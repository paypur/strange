...
public class StrangeRecipeProvider extends RecipeProvider {
    ...
    public StrangeRecipeProvider(DataGenerator pGenerator) {
        super(pGenerator);
    }
    ...
    //                    strangePart(pFinishedRecipeConsumer, item, Strange.STRANGE_PART_KILLS_ONE_SHOT.get());
                    ...
                    if (ItemTypeUtil.isDefense(item)) {
                        ...
                        strangePart(pFinishedRecipeConsumer, item, Strange.STRANGE_PART_DAMAGE_TAKEN.get());
                        strangePart(pFinishedRecipeConsumer, item, Strange.STRANGE_PART_HITS_TAKEN.get());
                    }
